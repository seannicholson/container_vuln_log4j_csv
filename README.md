...
*config.yml* provides script configuration information for vulnerability severity ratings and Qualys API URL
  ...
  `log4j_qids`: (inprog) added list for adding additional log4j QIDs or other QIDs for customized reports. List array element in other list lines are commented out. Currently only checking for QIDs 376157, 376178, 376194, and 376209 in both images and containers functions via checking each QID is within the vulnerabilities list of the image or container.
